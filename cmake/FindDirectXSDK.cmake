...
if (MINGW)
	...
	if (WIN32)
		...
		message(STATUS "Windows SDK Root from registry: ${WIN_SDK_ROOT}")
		set(CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION "10.0.22621.0" CACHE STRING "Windows SDK version")
		if (NOT ${WIN_SDK_ROOT} STREQUAL "")
		  ...
		  message(STATUS "Windows SDK Root from 32-bit registry: ${WIN_SDK_ROOT_32}")
	...
	message(STATUS "Final DXSDK_INCLUDE_PATHS after adding Windows SDK paths:")
	foreach(PATH ${DXSDK_INCLUDE_PATHS})
		message(STATUS "  ${PATH}")
	endforeach()
